...
val test3b1 = careful_player ([],0) = []
val test3b2 = careful_player ([(Clubs,Jack)],0) = []

(* pick one card *)
val test3b3 = careful_player ([(Clubs,Jack)],10) = [Draw]

(* pick 2, drop 1, pick 1 *)
val test3b4 = careful_player ([(Clubs,Jack),(Hearts,Num 1),(Diamonds,Ace)],21)
              = [Draw,Draw,Discard (Hearts,Num 1),Draw]

val test3b5 = careful_player ([(Clubs,Jack),(Hearts,Num 1),(Diamonds,Ace),(Hearts,Num 5)],26)
                             = [Draw,Draw,Draw,Discard (Hearts,Num 1),Draw]
